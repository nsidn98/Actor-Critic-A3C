...
def train(rank, args, shared_model, counter, lock, observation_space, action_space, optimizer=None):
    torch.manual_seed(args.seed + rank)

    # env = create_atari_env(args.env_name)
    # env.seed(args.seed + rank)
    observation_space =  observation_space # num_inputs in the network
    action_space = action_space # number of actions
